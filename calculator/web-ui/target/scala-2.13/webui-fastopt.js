  ...
  return $as_sci_Map(namedExpressions.map__F1__sc_IterableOps(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this, namedExpressions$1) {
    return (function(pair$2) {
      ...
      var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this$1, pair$1, namedExpressions$1$1) {
        return (function() {
          return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(pair$1.$$und2$f).apply__O()), namedExpressions$1$1)
        })
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, delta$1, b$1, a$1) {
    return (function() {
      ...
      var deltaSqrt = $uD($g.Math.sqrt(a$2));
      if (($uD(delta$1.apply__O()) < 0)) {
        return $m_sci_Set$EmptySet$()
      } else if (($uD(delta$1.apply__O()) === 0)) {
        var this$6 = $m_s_Predef$().Set$3;
        var array = [(((-$uD(b$1.apply__O())) / 2) * $uD(a$1.apply__O()))];
        var elems = new $c_sjsr_WrappedVarArgs().init___sjs_js_Array(array);
        return this$6.from__sc_IterableOnce__sci_Set(elems)
      } else {
        var this$10 = $m_s_Predef$().Set$3;
        var array$1 = [(((-$uD(b$1.apply__O())) + deltaSqrt) / (2 * $uD(a$1.apply__O()))), (((-$uD(b$1.apply__O())) - deltaSqrt) / (2 * $uD(a$1.apply__O())))];
        var elems$1 = new $c_sjsr_WrappedVarArgs().init___sjs_js_Array(array$1);
        return this$10.from__sc_IterableOnce__sci_Set(elems$1)
      }
    })
  })(this, delta, b, a));
  return new $c_Lcalculator_Signal().init___F0(expr)
